...
class VpnExtensionAPI : ContentProvider() {
    ...
    companion object {
        const val PREFERENCE_AUTHORITY = "com.fulldive.fulldivecleaner"
...
sealed class ModuleState(id: String) {
    object STARTING : ModuleState("STARTING")
    object RESTARTING : ModuleState("RESTARTING")
    object RUNNING : ModuleState("RUNNING")
    object STOPPING : ModuleState("STOPPING")
    object STOPPED : ModuleState("STOPPED")
    object FAULT : ModuleState("FAULT")
    object UNDEFINED : ModuleState("UNDEFINED")
}